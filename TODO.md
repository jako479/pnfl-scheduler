...
- Consider replacing the extra AFC East vs NFC East rank step and final H2H step
  in `fixed-matchup` scheduler with one joint solve over the remaining 13 non-conference games.
