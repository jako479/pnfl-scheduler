...
TEAMS: tuple[Team, ...] = (
    Team(0, "New England", Division.AFC_EAST),
    Team(1, "Miami", Division.AFC_EAST),
    Team(2, "Jacksonville", Division.AFC_EAST),
    Team(3, "Buffalo", Division.AFC_EAST),
    Team(4, "Cincinnati", Division.AFC_WEST),
    Team(5, "Pittsburgh", Division.AFC_WEST),
    Team(6, "Denver", Division.AFC_WEST),
    Team(7, "Los Angeles", Division.AFC_WEST),
    Team(8, "Las Vegas", Division.AFC_WEST),
    Team(9, "Washington", Division.NFC_EAST),
    Team(10, "Atlanta", Division.NFC_EAST),
    Team(11, "New York", Division.NFC_EAST),
    Team(12, "Philadelphia", Division.NFC_EAST),
    Team(13, "Chicago", Division.NFC_WEST),
    Team(14, "Minnesota", Division.NFC_WEST),
    Team(15, "San Francisco", Division.NFC_WEST),
    Team(16, "Green Bay", Division.NFC_WEST),
